      ...
      <div className="relative isolate h-3 w-full cursor-help rounded-sm bg-zinc-900 shadow-inner">
        ...
        <div className="absolute inset-0 flex overflow-hidden rounded-sm opacity-90">
          {zones.map((zone, idx) => (
            <div
              key={idx}
              className={`bg-linear-to-r ${zone.colorClass} border-r border-black/10 last:border-0`}
        ...
        <div
          className="absolute top-[-3px] bottom-[-3px] z-(--z-decorator) w-1.5 transition-all duration-300 ease-out will-change-[left]"
