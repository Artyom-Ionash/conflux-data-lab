  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <div className={containerVariants({ size })}>
        <input
          type="color"
          className="absolute inset-0 z-(--z-decorator) h-[150%] w-[150%] -translate-x-1/4 -translate-y-1/4 cursor-pointer opacity-0" // Заменено z-10 на семантический слой
          value={inputValue}
        ...
        <div
          className="absolute inset-0 z-(--z-base) bg-white" // Заменено z-0 на семантический слой
          style={{
        ...
        {/* Слой цвета */}
        <div
          className="absolute inset-0 z-(--z-content) transition-colors duration-200" // Заменено z-1 на семантический слой
