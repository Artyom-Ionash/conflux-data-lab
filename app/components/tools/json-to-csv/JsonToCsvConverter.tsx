        ...
        <Card>
          <div className="space-y-4">
            ...
            <textarea
              ...
              className="w-full h-64 rounded-md border border-zinc-300 bg-white px-3 py-2 font-mono text-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
            />
            {error && (
        ...
        <Card>
          <div className="space-y-4">
            ...
            <textarea
              ...
              className="w-full h-64 rounded-md border border-zinc-300 bg-zinc-50 px-3 py-2 font-mono text-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
            />
          </div>
        </Card>
      </div>
