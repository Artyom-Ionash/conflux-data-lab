    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-zinc-600 dark:text-zinc-400">
          Коллекция инструментов для конвертации, трансформации и обработки данных.
          Удобные и быстрые решения для работы с различными форматами данных.
        </p>
      </section>
      ...
      <section className="mt-12 rounded-lg border border-zinc-200 bg-zinc-50 p-6 text-center dark:border-zinc-800 dark:bg-zinc-900">
        <p className="text-zinc-600 dark:text-zinc-400">
          Всего инструментов: <span className="font-semibold text-zinc-900 dark:text-zinc-100">{tools.length}</span>
        </p>
      </section>
    </div>
  );
