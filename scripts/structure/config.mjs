...
export const IGNORE_PATTERNS = [
   ...
   * @param {string} relativePath - относительный путь от корня
   * @param {boolean} isDirectory - является ли директорией
   * @returns {string} - отформатированное имя
   */
  export function formatName(name, relativePath, isDirectory) {
   ...
   */
  export function shouldShow(name, fullPath, relativePath) {
